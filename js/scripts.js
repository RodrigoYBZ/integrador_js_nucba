...
const buyCarritoBtn = document.querySelector(".buy__carrito")
...
class UI {
    ...
    buyCarritoBtn.addEventListener("click", () =>{
    swal("Gracias por su compra!", "Nos pondremos en contacto a la brevedad", "success")
})
